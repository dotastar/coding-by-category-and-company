...
// *************************************************************************/
////NOTE:reduction of fractions to a common denominator(通分)
////NOTE:reduction of fraction
...
//    /**
//     * a1/b1 compareTo a2/b2 (通分) -> (a1b2 - a2*b1)/b1*b2 (due to b1 and b2 always larger than 0)
//     */
...
//        if (n < 0)
//            n = -n;
//        return m * (n / gcd(m, n)); // parentheses important to avoid overflow (if m * n is toooooo big!!!)
//    }
//
//    //NOTE: return a * b, staving off overflow as much as possible by cross-cancellation
//    //NOTE: prevent overflow is very important 
